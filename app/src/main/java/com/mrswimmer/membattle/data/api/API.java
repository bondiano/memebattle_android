package com.mrswimmer.membattle.data.api;

import com.mrswimmer.membattle.data.api.req.Id;
import com.mrswimmer.membattle.data.api.req.RegistrationUser;
import com.mrswimmer.membattle.data.api.req.Secret;
import com.mrswimmer.membattle.data.api.res.Exres;
import com.mrswimmer.membattle.data.api.res.rate.Rate;
import com.mrswimmer.membattle.data.api.res.ValidToken;
